...
export function SocialLinks({ className }: { className?: string }) {
  return (
    <div className={`${styles.social}${className ? ` ${className}` : ''}`}>
      <a
        href="https://x.com/sparklewarefun"
        className={styles.btn}
        aria-label="Sparkleware on X"
        target="_blank"
      ...
      <a
        href="https://github.com/sparkleware/sparkleware"
        className={styles.btn}
        aria-label="Sparkleware on GitHub"
        target="_blank"
        rel="noopener noreferrer"
      >
